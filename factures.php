...
$listeEmployes=$FactureC->afficherFacture();
...
<tbody>
  ...
  <td><?PHP echo $row['quArt']; ?></td>
  <td><?PHP echo $row['prTotal']; ?></td>
  <td><?PHP echo $row['etatFac']; ?></td>
  <td><?PHP echo $row['modPai']; ?></td>
  <td><form method="POST" action="../views/supprimerFacture.php">
  <input type="submit" name="supprimer" value="supprimer">
  <input type="hidden" value="<?PHP echo $row['idFac']; ?>" name="idFac">
  </form>
  </td>
  <td><a href="../views/modifierFacture.php?id=<?PHP echo $row['idFac']; ?>">
  Modifier</a></td>
  </tr>
