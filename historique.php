<?PHP
include "../login/core/historiqueC.php";
...
<tbody>
  ...
  <td><form method="POST" action="../login/views/supprimerHistorique.php">
  <input type="submit" name="supprimer" value="supprimer">
  <input type="hidden" value="<?PHP echo $row['reference']; ?>" name="reference">
  </form>
  
  </td>
  <td><a href="../login/views/modifierHistorique.php?id=<?PHP echo $row['reference']; ?>">
  Modifier</a></td>
  </tr>
...
<div id="wrapper" class="container">
    ...
    <form id="form-work" method="get" action="../login/views/ajouterHistorique.php" name="form-work" onsubmit="return verif()" >
        ...
        <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="nomarticle">Nom article</label>
              <input name="nomarticle" class="form-control" placeholder="Nom article" type="text"  >
            </div>
          </div>
