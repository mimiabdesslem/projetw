...
$commandes=$commandeC->showcommandes();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-lg-9 main-chart">
                    ...
                    <div class="table-responsive">
                        <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                            ...
                            <td><?php echo $commande['etatCom'] ?> </td>
                                    <td><?php echo $commande['tel'] ?> </td>
                            <td><a href="ImprimerCommande.php?id=<?php echo $commande["idCom"] ; ?>" >  Facture</a> </td>
                                    <td>
                                    <?php if( $commande['etatCom'] == "Valide"){?>
                            <a href="Deletecommandes.php?id=<?php echo $commande["idCom"] ; ?>" > Effacer </a>
                                    <?php }  else if( $commande['etatCom'] == "En Cours") {  ?>
                            <a href="modifiercommandes.php?id=<?php echo $commande["idCom"] ; ?>">Confirmer</a>
                                    <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
