...
$products=$CommandeC->getProducts();
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<div class="product-btns">
													<a href="AjouterFavoris.php?id=<?php echo $product['id_article'] ;  ?>" class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">Favoris</span></a>
													<button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp">Détails</span></button>
												</div>
											</div>
											<div class="add-to-cart">
												<a href="AjouterPanier.php?id=<?php  echo $product['id_article'] ; ?>&quantite=1" ><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Ajouter au panier</button></a>
											</div>
										</div>
										<!-- /product -->
                                        <?php }?>
